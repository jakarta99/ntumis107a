...
<html >
    ...
    <section class="page-section clearfix">
      <div class="container">
        <div class="intro">
          <img class="intro-img img-fluid mb-3 mb-lg-0 rounded" src="/images/00_Meal-Tricks-Every-Diabetic-Must-Follow-to-Survive-Holiday-Dinners_526855693-Rawpixel.com_FT.jpg" alt="">
