      ...
      <div class="container">
        <div class="intro">
          ...
          <div class="intro-text left-0 text-center bg-faded p-5 rounded" style='width:100% ;position: relative'>
		     ...
		     <p>
              <a class="btn btn-dark btn-lg" style="color:orange;" onclick="javascript:location.href='/choose-category-foreverylocation?beginPrice=1&endPrice=99'">1~99</a>
		      <a class="btn btn-dark btn-lg" style="color:orange;" onclick="javascript:location.href='/choose-category-foreverylocation?beginPrice=100&endPrice=199'">100~199</a>
		      <a class="btn btn-dark btn-lg" style="color:orange;" onclick="javascript:location.href='/choose-category-foreverylocation?beginPrice=200&endPrice=1000'">200+</a>
             </p>
